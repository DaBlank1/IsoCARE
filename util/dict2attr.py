...
refine_param = [ 'normalize_percentile', 'batch_normalization', 'filter_base', 'unet_depth', 'pool', 'kernel', 'convs_per_depth', 'drop_out','noise_dir', 
                ...
                'preprocessing_ncpus', 'result_dir', 'continue_iter', 'log_level', 'pretrained_model', 'data_dir', 'data_dir_odd', 'data_dir_even', 'iterations', 'gpuID', 'subtomo_star','cmd','subtomo_star_even','subtomo_star_odd',
                'select_subtomo_number','remove_intermediate']
predict_param = ['tomo_idx', 'Ntile', 'log_level', 'normalize_percentile', 'batch_size', 'use_deconv_tomo', 'crop_size', 'cube_size', 'gpuID', 'output_dir', 'model', 'star_file_odd', 'star_file_even', 'star_file']
