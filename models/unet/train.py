...
from IsoCARE.models.unet.data_sequence import prepare_dataseq
from IsoCARE.models.unet.model import Unet
import numpy as np
...
def train3D_continue(outFile,
    ...
    train_data, test_data= prepare_dataseq(data_dir, data_dir_odd,data_dir_even, batch_size)
